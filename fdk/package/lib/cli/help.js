...
function productDocumentationUrl(){
  const PRODUCTHELPURL = require('../utils/product-info-util').getProductDoc();

  console.log('\nFor fdk documentation please visit:');
  Object.keys(PRODUCTHELPURL).forEach((product)=> {console.log(product, '\t'+PRODUCTHELPURL[product]);});
  console.log();
}
